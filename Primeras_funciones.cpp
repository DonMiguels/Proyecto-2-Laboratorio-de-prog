/*
    1.VERIFICA QUE EL ARCHIVO TENGA LA EXTENSION CORRESPONDIENTE, AL ABRIR EL ARCHIVO NO RECONOCIA LA EXTENSION.
    2.ACOSTUMBRATE A ESCRIBIR LOS NOMBRES DE PROGRAMAS EN CAMEL CASE O SNAKE CASE
    3.FALTAN FUNCIONES, AGREGAR NUEVOS ESTUDIANTES, MOSTRAR UN ESTUDIANTE Y SU INFORMACION JUNTO AL PROMEDIO
*/
#include <iostream>
#include <fstream>
#include <string>
